...
#ifdef GPU_OACC
  #pragma acc enter data create(number_of_partners[0:N], key_pointer[0:N], sorted_list[0:PAIRLIST_SIZE])
#endif
}
//----------------------------------------------------------------------
...
#ifdef GPU_OACC
  #pragma acc exit data delete(number_of_partners, key_pointer, sorted_list)
#endif
}
//----------------------------------------------------------------------
void
